...
disease.cell.unknown <- ggplot(umap.data, aes(x = UMAP1, y = UMAP2, color = cell.type)) +
  geom_point() +
...
table(sce.annot$cluster40, sce.annot$cell.type)
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Microglía' & sce.annot$cluster40 == '1')]
...
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Oligodendrocitos' & sce.annot$cluster40 == '10')]
