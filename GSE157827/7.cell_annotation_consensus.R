...
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Inhibidoras' & sce.annot$cluster40 == '2')]
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Excitadoras' & sce.annot$cluster40 == '3')]
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Oligodendrocitos' & sce.annot$cluster40 == '4')]
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Excitadoras' & sce.annot$cluster40 == '5')]
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Oligodendrocitos' & sce.annot$cluster40 == '6')]
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Astrocitos' & sce.annot$cluster40 == '7')]
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Microglía' & sce.annot$cluster40 == '8')]
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'OPC' & sce.annot$cluster40 == '9')]
sce.annot <- sce.annot[ , !(sce.annot$cell.type != 'Excitadoras' & sce.annot$cluster40 == '10')]
