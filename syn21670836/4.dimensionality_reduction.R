...
jpeg(file = './figures/4.dimensionality_reduction/plot.umap.groupsex.n300.jpeg', width=10, height=6, units="in", res=300)
print(plot.umap.groupsex.n300)
dev.off()
svg(file = './figures/4.dimensionality_reduction/plot.umap.groupsex.n300', width=10, height=6)
print(plot.umap.groupsex.n300)
dev.off()
